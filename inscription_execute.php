...
// Vérification impérative de l'accord des règles
if (!$accord_regles) {
    $_SESSION['erreur_inscription'] = "Vous devez accepter la Charte de la communauté pour vous inscrire.";
    header('Location: inscription.php');
    exit();
}
...
try {
    ...
    // Insertion de la signature légale dans jevend_accords_commun
    $insert_accord = $bdd->prepare("INSERT INTO jevend_accords_commun (nom, cell, courriel) VALUES (?, ?, ?)");
    $insert_accord->execute([$nom, $cellulaire, $courriel]);
