...
require_once 'partials/_nombre_annonces.php';
...
<?php include 'partials/_nav_membre.php'; ?>
    <div class="admin-conteneur">
        ...
        <!-- INCLUSION DE L'ONGLET 1 : MES VITRINES -->
        <?php include 'partials/_espace_membre_mes_vitrines.php'; ?>

        <!-- INCLUSION DE L'ONGLET 2 : BON PLAN DE VENTE -->
